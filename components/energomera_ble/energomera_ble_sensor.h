...
#ifdef USE_SENSOR
class EnergomeraBleSensor : public EnergomeraBleSensorBase, public sensor::Sensor {
 public:
...
#ifdef USE_TEXT_SENSOR
class EnergomeraBleTextSensor : public EnergomeraBleSensorBase, public text_sensor::TextSensor {
 public:
